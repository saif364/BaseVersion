...
//   name: "default",
//   pattern: "", // Make slug optional by using '?'
//   defaults: new { controller = "Home", action = "Index" } // Default to HomeController.Index
//);

//// Middleware to rewrite all URLs to the root
